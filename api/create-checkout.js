...
// =====================================================================
import { stripe, PRICE_EARTHQUEST, SITE_ORIGIN, corsHeaders, json } from './_shared.js';
...
export async function POST(request) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      metadata: { product: 'earth_quest' },
      payment_intent_data: { metadata: { product: 'earth_quest' } }
    });
